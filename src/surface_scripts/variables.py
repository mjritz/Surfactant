    ...
    for vars in var_file.readlines():
        if '#' not in vars:
            ...
            if variable[0] == 'DCD_filename':
                ...
                prod_dcd = variable[2]
    return xbox, ybox, zbox, w_filename, w_mol, pack_tol, bead_dist, boxx, boxy, boxz, bead_per, equil_time, surf_x, surf_y, surf_zlow, surf_zhi, per_loop, steps, temp, z_distance, epsilon, sigma, r_distance, equil_dcd, prod_dcd
